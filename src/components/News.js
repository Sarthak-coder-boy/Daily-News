...
export default function News (props){
  ...
  useEffect(()=>{
    document.title = `${capitalized(props.category)} - Daily News`;
    updateNews();
  ...
  setTotalResults(parsedData.totalResults)
    ...
    return (
     <>
        <h1 className="text-center" style={{margin:'35px 0px' , marginTop: '90px'}}> Daily News - Top {capitalized(props.category)} Headlines</h1>
      { loading && <Spinner/>}
      <InfiniteScroll
